...
import {
  HERO_JOBS,
  type HeroJobIcon as HeroJobIconName,
} from "@/data/hero-jobs";
...
function HeroJobIcon({ kind }: { kind: HeroJobIconName }) {
  switch (kind) {
    case "outbound":
      return (
        <svg viewBox="0 0 24 24" fill="none" aria-hidden>
  ...
  return (
    <>
      <div className="hero-copy">
        <p className="eyebrow">A proactive agent for every Broadcom seller</p>
        <h1>The agents that work while your reps sell.</h1>
        <p className="hero-intro">
          Grok Bot watches for account work, opens the right tools, and gets a
          draft ready in the background. The rep stays with the customer.
        </p>
        ...
        <div className="hero-phone">
          ...
          <header className="hero-phone-header">
            ...
            <span className="hero-phone-agent" aria-hidden>
              <HeroJobIcon kind={activeJob.icon} />
            </span>
            <p>
